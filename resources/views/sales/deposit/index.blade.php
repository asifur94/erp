        ...
        <div class="mx-auto p-2" >
          ...
          <div class="flex flex-wrap flex-row" >
            <div class="flex-shrink max-w-full px-4 w-full" >
              <p class="text-xl font-bold mt-3 mb-5">Deposit</p>
            </div>
                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" >
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="text-center lg:table-cell">5345$</td>
                              <td class="text-center hidden lg:table-cell">
                                <div class="self-center"><img class="h-8 w-8" src="{{asset('assets/img/blue.jpeg')}}">
                                </div>
                              </td>
                              <td class="hidden lg:table-cell">
                                <span class="text-sm px-2 py-1 font-semibold leading-tight bg-yellow-400 rounded-full">Deposit</span>
                              </td>
                            ...
                            <tr>
                                ...
                                <td class="hidden lg:table-cell">
                                  <span class="text-sm px-2 py-1 font-semibold leading-tight bg-green-400 rounded-full">Received</span>
                                </td>
                                <td class="text-center">
                                  <a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
