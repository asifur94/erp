        ...
        <div class="mx-auto p-2" >
          ...
          <div class="flex flex-wrap flex-row" >
            <div class="flex-shrink max-w-full px-4 w-full" >
              <p class="text-xl font-bold mt-3 mb-5">Manage payments</p>
            </div>
            ...
            <div class="mb-4 px-4 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-5 w-full" >
                ...
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md" >
                    ...
                    <div class="p-4 text-right" >
                        <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Today's Sell</p>
                ...
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md" >
                    ...
                    <div class="p-4 text-right" >
                        <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Today Deposit</p>
                ...
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md" >
                    ...
                    <div class="p-4 text-right" >
                        <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Today Expanse</p>
                ...
                <div class="flex flex-wrap flex-row -mx-4" >
                  <div class="flex-shrink max-w-full px-4 w-full" >
                    <div class="md:flex md:justify-between" >
                      <div >
                        <a href="" class="py-2 px-4 mb-3 block lg:inline-block text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">28th June
                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" >
                          ...
                          <thead>
                            <tr class="bg-gray-100">
                              ...
                              <th class="hidden lg:table-cell" data-sortable="" style="width:10%;">
                                <a href="#" class="dataTable-sorter">Due</a>
                              </th>
                              <th class="hidden lg:table-cell" data-sortable="" style="width: 10%;">
                          ...
                          <tbody>
                            <tr>
                                ...
                                <a href="{{ 'payment' }}">
                                  <div class="flex flex-wrap flex-row items-center" >
                                    <div class="self-center">
                                        <img class="h-8 w-8" src="{{asset('assets/img/blue.jpeg')}}"></div>
                              ...
                              <td class="hidden lg:table-cell">200$</td>
                              ...
                              <td class="hidden lg:table-cell">
                                <span class="text-sm px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">Received</span>
                              </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center hidden lg:table-cell">20$</td>
                                <td class="hidden lg:table-cell">
                                  <span class="text-sm px-2 py-1 font-semibold leading-tight  bg-yellow-400 rounded-full">Pending</span>
                                </td>
                                <td class="text-center">
                                  <a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
