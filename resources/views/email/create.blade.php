            ...
            @include('layouts.header')
              ...
              <main class="flex w-full h-full   pt-16 -mt-2">
                ...
                <section class=" px-20 w-full flex flex-col bg-white ">
                  ...
                  <section>
                    <h1 class="font-bold mt-5 text-2xl">Create Mail</h1>
                    <article class="mt-8 text-gray-500 leading-7 tracking-wider">
                        <form class="flex flex-wrap flex-row -mx-4">
                            ...
                            <div class="flex-shrink max-w-full px-4 w-full  mb-6" >
                              ...
                              <input type="Text" placeholder="Subjact" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 " >
                            </div>
                          </form>
