        ...
        <div class="mx-auto p-2" >
          ...
          <div class="flex flex-wrap flex-row" >
            <div class="flex-shrink max-w-full px-4 w-full" >
              <p class="text-xl font-bold mt-3 mb-5">Role</p>
            </div>
                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" >
                          ...
                          <thead>
                            <tr class="bg-gray-100">
                              ...
                              <th data-sortable="" style="width: 5%;">
                                <a href="#" class="dataTable-sorter">SL</a>
                              </th>

                              <th class="lg:table-cell" data-sortable="" style="width: 15%;">
                                <a href="#" class="dataTable-sorter">Name</a>
                              </th>

                              <th class="hidden lg:table-cell" data-sortable="" style="width: 80%;">
                                <a href="#" class="dataTable-sorter">Permission</a>
                              </th>
                          ...
                          <tbody>
                            <tr>
                                ...
                                <td class="text-center lg:table-cell">01</td>
                              ...
                              <td class="hidden text-center lg:table-cell"><span class="text-sm px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">Super Admin</span></td>
